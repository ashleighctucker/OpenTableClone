...
def seed_restaurants():
    ...
    The restaurant is reminiscent of the classic grills of San Francisco and New York - mahogany booths, granite bar, and original brass fire pole with eclectic old filament light bulbs to add to the motif.""", cuisine_type=3, user_id=2, cover_photo="https://images.unsplash.com/photo-1604328471151-b52226907017?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80", createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())
    ...
    marco_polo = Restaurant(
        name="Marco Polo at Silver Lake Pool & Inn", location="Silver Lake", price_point=2, phone_number="(323) 486-7176", open_time="11:00 AM", close_time="3:00 PM", contact_email="marcopolo@silverlakepi.com", description="""We believe in an afternoon spritz, pasta for lunch, a good espresso or two, and taking a refreshing dip between courses. An inviting al fresco dining experience with a low-key locals vibe. Everyone welcome!""", cuisine_type=4, user_id=1, cover_photo="https://images.unsplash.com/photo-1424847651672-bf20a4b0982b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80", createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())
