...
def seed_restaurants():
    ...
    sage_plant = Restaurant(
        name="Sage Plant Based Bistro & Brewery- Pasadena", location="Pasadena", price_point=2, phone_number="(626) 564-8111", open_time="9:00 AM", close_time="10:00 PM", contact_email="null", description="""We are organic, sustainable, plant-based food without the pretense. We are the place where you can bring your date at night and your momma in the morning.""", cuisine_type=5, user_id=2, cover_photo="https://resizer.otstatic.com/v2/photos/wide-huge/3/26703898.jpg", createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())
