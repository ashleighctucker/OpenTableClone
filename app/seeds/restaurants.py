...
def seed_restaurants():
    chin_chin = Restaurant(
        name="Chin Chin", location="West Hollywood", price_point=2, phone_number="(310) 652-1818", open_time="12:00 PM", close_time="9:00 PM", contact_email="ChinChin@food.com", description="""Coming Soon!Chin Chin® made its debut on Sunset Blvd in Los Angeles in 1983, introducing dim sum and other Chinese favorites prepared using traditional Cantonese cooking techniques. Each dish is made with premium ingredients, fresh-to-order, without adding any MSG, and served in a contemporary environment with friendly and efficient service.
    ...
    Our longevity and success is because of our team of passionate professionals that are truly committed to delivering the best American Asian cuisine and a genuinely enjoyable dining experience.""", cuisine_type=1, user_id=1, cover_photo="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80", createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())

    mr_chow = Restaurant(
        name="Mr. Chow", location="Beverly Hills", price_point=4, phone_number="(310) 278-9911", open_time="5:30 PM", close_time="11:30 PM", contact_email="MrChow@food.com", description="""Opened in 1974 by world famous restaurateur Michael Chow. MR CHOW started in London in 1968 and continues to enjoy generations of devoted clients from art, fashion, music, and entertainment. Art, celebrity and superb cuisine all blend together in this stylish restaurant in the heart of Beverly Hills, it has always been an institution for Hollywood’s biggest stars and its loyal clients.
    ...
    “Mr. Chow defies all odds and remains an impossibly chic spot that still draws the rich, famous and well-heeled decades after." - Los Angeles Times""", cuisine_type=1, user_id=2, cover_photo="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80",  createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())

    fifty_kitchen = Restaurant(
        name="Fifty One Kitchen", location="Culver City", price_point=3, phone_number="(310) 559-5966", open_time="12:00 PM", close_time="8:00 PM", contact_email="fiftyonekitchen@gmail.com", description="At Fifty One Kitchen, the passion for traditional Chinese, made-from-scratch cooking juxtaposed with reputable Chinese culinary expertise is clearly evident in its innovative wok-style and hand-prepped dishes including carefully-crafted handmade sauces, live seafood, and dim sum favorites. Using fresh farm-to-table ingredients, no MSG, no artificial flavoring, and low sodium, Fifty One Kitchen allows you to indulge in purposeful, quintessential Chinese comfort food at the heart of Los Angeles.", cuisine_type=1, user_id=3, cover_photo="https://images.unsplash.com/photo-1560624052-449f5ddf0c31?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1335&q=80", createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())

    tatel_hills = Restaurant(
        name="Tatel Beverly Hills", location="Beverly Hills", price_point=3, phone_number="(424) 380-7902", open_time="12:00 PM", close_time="12:00 AM", contact_email="Tatel@food.com", description="""Based in Madrid and Ibiza TATEL represent the quintessential Spanish traditional Mediterranean recipes with a contemporary twist.
    ...
    A high gastronomic concept with daily live music shows.""", cuisine_type=2, user_id=3, cover_photo="https://images.unsplash.com/photo-1514933651103-005eec06c04b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1974&q=80", createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())

    manchengo_manchengo = Restaurant(
        name="Manchengo", location="Santa Monica", price_point=2, phone_number="(310) 450-3900", open_time="5:00 PM", close_time="9:00 PM", contact_email="Manchengo@food.com", description="""Manchego also offers walk-ins!
    ...
    Located in the Arts District at 555 Mateo, Girl & the Goat offers dinner service Monday through Sunday, plus brunch Sunday. Girl & the Goat accepts reservations but always welcomes walk-ins, nomads and adventurers!""", cuisine_type=3, user_id=1, cover_photo="https://images.unsplash.com/photo-1570560258879-af7f8e1447ac?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1974&q=80", createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())
    ...
    The restaurant is reminiscent of the classic grills of San Francisco and New York - mahogany booths, granite bar, and original brass fire pole with eclectic old filament light bulbs to add to the motif.""", cuisine_type=3, user_id=2, cover_photo="https://images.unsplash.com/photo-1583426189374-8090f9dd26cf?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1331&q=80", createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())

    weho_the = Restaurant(
        name="WeHo Bistro", location="West Hollywood", price_point=2, phone_number="(310) 657-9696", open_time="11:00 AM", close_time="10:00 PM", contact_email="meet@wehobistro.com", description="""French Casual Cuisine in the center of WeHo. Delicious food. Incredible wine selection & Cocktail Bar. A Comfortable place to spend time with friends and family. Attentive Service. And 84 free parking spots on 3 levels shared with CVS.""", cuisine_type=4, user_id=1, cover_photo="https://images.unsplash.com/photo-1587899897387-091ebd01a6b2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2413&q=80")

    marco_polo = Restaurant(
        name="Marco Polo at Silver Lake Pool & Inn", location="Silver Lake", price_point=2, phone_number="(323) 486-7176", open_time="11:00 AM", close_time="3:00 PM", contact_email="marcopolo@silverlakepi.com", description="""We believe in an afternoon spritz, pasta for lunch, a good espresso or two, and taking a refreshing dip between courses. An inviting al fresco dining experience with a low-key locals vibe. Everyone welcome!""", cuisine_type=4, user_id=1, cover_photo="https://images.unsplash.com/photo-1602232037779-30b01ac3c457?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80", createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())

    mazal_mazal = Restaurant(
        name="Mazal", location="Echo Park", price_point=2, phone_number="(323) 576-2138", open_time="5:00 PM", close_time="9:00 PM", contact_email="Mazal@food.com", description="""A handcrafted and carefully selected collection of shareable small plates and appetizers, Mazal provides a new perspective on Israeli cuisine. Our open kitchen setting and transparent atmosphere allow you to briefly step into our home. Supported by a robust and exciting natural/organic wine menu and independent craft beer selection, the plant-based menu provides an array of fresh ingredients that will transport you to a night out on the Mediterranean.""", cuisine_type=4, user_id=2, cover_photo="https://images.unsplash.com/photo-1600767421554-069608adb34d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1275&q=80", createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())

    sage_plant = Restaurant(
        name="Sage Plant Based Bistro & Brewery- Pasadena", location="Pasadena", price_point=2, phone_number="(626) 564-8111", open_time="9:00 AM", close_time="10:00 PM", contact_email="SagePlantBistro@food.com", description="""We are organic, sustainable, plant-based food without the pretense. We are the place where you can bring your date at night and your momma in the morning.""", cuisine_type=5, user_id=2, cover_photo="https://images.unsplash.com/photo-1597252395096-30cd2dcd628c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1197&q=80", createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())

    stk = Restaurant(
        name="STK - Los Angeles", location="Westwood", price_point=4, phone_number="(310) 659-3535", open_time="3:00 PM", close_time="10:00 PM", contact_email="STK@food.com", description="""***** We are thrilled to offer STK Under the Stars at our poolside restaurant while we observe social distance dining at STK Los Angeles. All STK reservations prior to 3pm will be offered the Hideout menu.
    STK artfully blends two concepts into one—the modern steakhouse and a chic lounge. A large central lounge area is furnished with creamy leather banquettes and textured crocodile tiles, and is surrounded by an elevated dining room for more formal dining. Theatrical lights illuminate each table, while smoky mirrors allow patrons to catch a glimpse of the surroundings while a DJ creates an energetic vibe throughout the entire space. STK Los Angeles is located in the heart of Westwood at the W Hotel Los Angeles- West Beverly Hills. As anticipated, steak is the main attraction. STK offers small, medium and large cuts of meat, as well as naturally raised options and market fresh fish entrees.""", cuisine_type=5, user_id=3, cover_photo="https://images.unsplash.com/photo-1571168136613-46401b03904e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80", createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())
    ...
    As one of the premier restaurants in Los Angeles, our menu is rich with a diverse selection of today's favorites and the all time classics.""", cuisine_type=5, user_id=2, cover_photo="""https://images.unsplash.com/photo-1546195643-70f48f9c5b87?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80""", createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())

    mama = Restaurant(
        name="Mama Por Dios", location="Beverly Hills", price_point=2, phone_number="(424) 284-3052", open_time="5:00 PM", close_time="12:00 AM", contact_email="MamaPorDios@food.com", description="""LIVE THE EXPERIENCE IN EVERY DISH!
    Mamá Por Dios is a restaurant that highlights the best of México, with its flavors, aromas, colors, traditions, and art. Bringing it closer to its customers and every drink in every corner.""", cuisine_type=5, user_id=1, cover_photo="""https://images.unsplash.com/photo-1583950687652-1cc0ccb2a570?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=735&q=80""", createdat=datetime.datetime.utcnow(), updatedat=datetime.datetime.utcnow())
