...
def seed_users():
    ...
    Our longevity and success is because of our team of passionate professionals that are truly committed to delivering the best American Asian cuisine and a genuinely enjoyable dining experience.""", cuisine_type=1, user_id=1, header_image="https://resizer.otstatic.com/v2/photos/wide-huge/2/42115186.jpg", created_at = datetime.datetime.utcnow(), updated_at = datetime.datetime.utcnow())
    ...
    “Mr. Chow defies all odds and remains an impossibly chic spot that still draws the rich, famous and well-heeled decades after." - Los Angeles Times""", cuisine_type = 1, user_id = 2, header_image = "https://resizer.otstatic.com/v2/photos/wide-huge/1/25923645.jpg",  created_at = datetime.datetime.utcnow(), updated_at = datetime.datetime.utcnow())
    ...
    A high gastronomic concept with daily live music shows.""", cuisine_type = 2, user_id = 3, header_image = "https://resizer.otstatic.com/v2/photos/wide-huge/3/42788652.jpg", created_at = datetime.datetime.utcnow(), updated_at = datetime.datetime.utcnow())
    ...
    Follow us on instagram at instagram.com/manchegorestaurant""", cuisine_type = 2, user_id = 1, header_image = "https://resizer.otstatic.com/v2/photos/legacy/1/24610451.jpg", created_at = datetime.datetime.utcnow(), updated_at = datetime.datetime.utcnow())
    ...
    As one of the premier restaurants in Los Angeles, our menu is rich with a diverse selection of today's favorites and the all time classics.""", cuisine_type = 5, user_id = 2, header_image = """https://resizer.otstatic.com/v2/photos/wide-huge/1/32331448.jpg""", created_at = datetime.datetime.utcnow(), updated_at = datetime.datetime.utcnow())
