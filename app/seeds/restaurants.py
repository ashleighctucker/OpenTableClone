...
def seed_users():
    ...
    Our longevity and success is because of our team of passionate professionals that are truly committed to delivering the best American Asian cuisine and a genuinely enjoyable dining experience.""", cuisine_type=1, user_id=1, header_image="https://resizer.otstatic.com/v2/photos/wide-huge/2/42115186.jpg")
    ...
    A high gastronomic concept with daily live music shows.""", cuisine_type = 2, user_id = 4, header_image = "https://resizer.otstatic.com/v2/photos/wide-huge/3/42788652.jpg")
    ...
    Follow us on instagram at instagram.com/manchegorestaurant""", cuisine_type = 2, user_id = 5, header_image = "https://resizer.otstatic.com/v2/photos/legacy/1/24610451.jpg")
    ...
    Valet Parking is mandatory on Friday & Saturday Nights and generally during all major holidays. Valet is $6/vehicle. Also most of the month of December we have daily valet.""", cuisine_type = 2, user_id = 6, header_image = "https://resizer.otstatic.com/v2/photos/wide-huge/3/26375867.jpg")
    ...
    Located in the Arts District at 555 Mateo, Girl & the Goat offers dinner service Monday through Sunday, plus brunch Sunday. Girl & the Goat accepts reservations but always welcomes walk-ins, nomads and adventurers!""", cuisine_type = 3, user_id = 8, header_image = "https://resizer.otstatic.com/v2/photos/wide-huge/2/42434778.jpg")
    ...
    The restaurant is reminiscent of the classic grills of San Francisco and New York - mahogany booths, granite bar, and original brass fire pole with eclectic old filament light bulbs to add to the motif.""", cuisine_type = 3, user_id = 9, header_image = "https://resizer.otstatic.com/v2/photos/wide-huge/1/26073210.jpg")

    weho_the = Restaurant(
        name = "WeHo Bistro", location = "West Hollywood", price_point = 2, phone_number = "(310) 657-9696", open_time = "11:00 AM", close_time = "10:00 PM", contact_email = "meet@wehobistro.com", description = """French Casual Cuisine in the center of WeHo. Delicious food. Incredible wine selection & Cocktail Bar. A Comfortable place to spend time with friends and family. Attentive Service. And 84 free parking spots on 3 levels shared with CVS.""", cuisine_type = 4, user_id = 10, header_image = "https://resizer.otstatic.com/v2/photos/legacy/1/23674924.jpg")

    marco_polo= Restaurant(
        name = "Marco Polo at Silver Lake Pool & Inn", location = "Silver Lake", price_point = 2, phone_number = "(323) 486-7176", open_time = "11:00 AM", close_time = "3:00 PM", contact_email = "marcopolo@silverlakepi.com", description = """We believe in an afternoon spritz, pasta for lunch, a good espresso or two, and taking a refreshing dip between courses. An inviting al fresco dining experience with a low-key locals vibe. Everyone welcome!""", cuisine_type = 4, user_id = 11, header_image = "https://resizer.otstatic.com/v2/photos/wide-huge/4/27918547.jpg")

    mazal_mazal = Restaurant(
        name = "Mazal", location = "Echo Park", price_point = 2, phone_number = "(323) 576-2138", open_time = "5:00 PM", close_time = "9:00 PM", contact_email = "null", description = """A handcrafted and carefully selected collection of shareable small plates and appetizers, Mazal provides a new perspective on Israeli cuisine. Our open kitchen setting and transparent atmosphere allow you to briefly step into our home. Supported by a robust and exciting natural/organic wine menu and independent craft beer selection, the plant-based menu provides an array of fresh ingredients that will transport you to a night out on the Mediterranean.""", cuisine_type = 4, user_id = 12, header_image = "https://resizer.otstatic.com/v2/photos/wide-huge/1/32375279.jpg")



    sage_plant = Restaurant(
        name = "Sage Plant Based Bistro & Brewery- Pasadena", location = "Pasadena" , price_point = 2, phone_number = "(626) 564-8111", open_time = "9:00 AM", close_time = "10:00 PM", contact_email = "null", description = """We are organic, sustainable, plant-based food without the pretense. We are the place where you can bring your date at night and your momma in the morning.""", cuisine_type = 5, user_id = 13, header_image = "https://resizer.otstatic.com/v2/photos/wide-huge/3/26703898.jpg")
    ...
    As one of the premier restaurants in Los Angeles, our menu is rich with a diverse selection of today's favorites and the all time classics.""", cuisine_type = 5, user_id = 14, header_image = """https://resizer.otstatic.com/v2/photos/wide-huge/1/32331448.jpg""")
    ...
    Mamá Por Dios is a restaurant that highlights the best of México, with its flavors, aromas, colors, traditions, and art. Bringing it closer to its customers and every drink in every corner.""", cuisine_type = 5, user_id = 15, header_image = """https://resizer.otstatic.com/v2/photos/wide-huge/3/42264511.jpg""")
